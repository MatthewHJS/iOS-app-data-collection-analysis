...
'''
concurrentcrawler.py

Crawler for the first iteration made concurrently, used this to test if my concurrent solution worked before applying it 
to more nodes in the leaf_app.csv file.
